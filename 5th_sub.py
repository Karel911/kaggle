...
macro = pd.read_csv('/Users/Karel/Documents/PycharmProjects/Kaggle/Sberbank/macro.csv', parse_dates=['timestamp'])
...
cv_output = xgb.cv(xgb_params, dtrain, num_boost_round=5000, early_stopping_rounds=20,verbose_eval=50, show_stdv=False) #modify here
#cv_output[['train-rmse-mean', 'test-rmse-mean']].plot()

print('best num_boost_rounds = ', len(cv_output))
# num_boost_rounds = len(cv_output)

#num_boost_rounds = 422 #422
...
gunja_output.head()
gunja_output.to_csv('5th_sub.csv', index=False)
...
df_train = pd.read_csv('/Users/Karel/Documents/PycharmProjects/Kaggle/Sberbank/train.csv', parse_dates=['timestamp'])
df_test = pd.read_csv('/Users/Karel/Documents/PycharmProjects/Kaggle/Sberbank/test.csv', parse_dates=['timestamp'])
df_macro = pd.read_csv('/Users/Karel/Documents/PycharmProjects/Kaggle/Sberbank/macro.csv', parse_dates=['timestamp'])
...
num_boost_rounds = 420  # From Bruno's original CV, I think 420
model = xgb.train(dict(xgb_params, silent=0), dtrain, num_boost_round=num_boost_rounds)
...
result.head()
result.to_csv('5th_sub.csv', index=False)
'''